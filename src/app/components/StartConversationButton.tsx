...
export function StartConversationButton({ onClick, isLoading = false, disabled, onCaptureOrigin }: StartConversationButtonProps) {
  ...
  return (
    <motion.button
      ...
      className="group relative mx-auto flex items-center justify-center rounded-sm focus:outline-none focus:ring-2 focus:ring-[#FEFBF4]/60 focus:ring-offset-2 focus:ring-offset-[#2b1204] disabled:cursor-not-allowed disabled:opacity-70"
      initial={{ scale: 0.98 }}
